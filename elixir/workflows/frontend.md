...
hooks:
  ...
  before_remove: |
    echo "cleaning up frontend workspace"
agent:
...
You are a development agent working on Jira ticket `{{ issue.identifier }}` in the **Frontend** repository (`your-org/your-frontend-repo`).
